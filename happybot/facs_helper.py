            ...
            if self.emotions[i] != -1:
                ...
                if (4 in idxT and 2 in idxB):
                    ...
                    self.flagSet[i] = 1
                        ...
                        0 in idxT and 1 in idxT and 3 in idxT and 8 in idxB):  # exchanging jaw drop AU 26 for lips part 25
                    ...
                    self.flagSet[i] = 1
                        ...
                        0 in idxT or 2 in idxT or 3 in idxT)):  # exchanging jaw drop AU 26 for lips part 25
