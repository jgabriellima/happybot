...
class faceUtil:
    ...
    def __init__(self):
        ...
        filename = os.path.join(dirname, '../data/shape_predictor_68_face_landmarks.dat')
        print(filename)
        self.predictor_path = filename
    ...
    def get_vec(self, image, centerFixed):
